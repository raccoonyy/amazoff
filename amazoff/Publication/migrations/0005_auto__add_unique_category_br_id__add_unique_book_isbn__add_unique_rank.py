...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Category', fields ['br_id']
        db.create_unique(u'publication_category', ['br_id'])

        # Adding unique constraint on 'Book', fields ['isbn']
        db.create_unique(u'publication_book', ['isbn'])
    ...
    def backwards(self, orm):
        ...
        db.delete_unique(u'publication_book', ['isbn'])

        # Removing unique constraint on 'Category', fields ['br_id']
        db.delete_unique(u'publication_category', ['br_id'])
