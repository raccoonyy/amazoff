...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'publication_category', 'br_id', self.gf('django.db.models.fields.CharField')(max_length=7, unique=True, null=True))

    def backwards(self, orm):

        # Changing field 'Category.br_id'
        db.alter_column(u'publication_category', 'br_id', self.gf('django.db.models.fields.IntegerField')(unique=True, max_length=7, null=True))
    ...
    models = {
        ...
        u'publication.category': {
            ...
            'br_id': ('django.db.models.fields.CharField', [], {'max_length': '7', 'unique': 'True', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
