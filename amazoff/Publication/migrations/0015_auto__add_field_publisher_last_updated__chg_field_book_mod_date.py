...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Publisher.last_updated'
        db.add_column(u'publication_publisher', 'last_updated',
                      self.gf('django.db.models.fields.DateField')(auto_now=True, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Book.mod_date'
        db.alter_column(u'publication_book', 'mod_date', self.gf('django.db.models.fields.DateField')(auto_now=True, null=True))

    def backwards(self, orm):
        # Deleting field 'Publisher.last_updated'
        db.delete_column(u'publication_publisher', 'last_updated')


        # Changing field 'Book.mod_date'
        db.alter_column(u'publication_book', 'mod_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, null=True))
